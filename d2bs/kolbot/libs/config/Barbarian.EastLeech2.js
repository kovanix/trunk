...
function LoadConfig() {
	...
	Scripts.BattleOrders = true;
		...
		Config.BattleOrders.Getters = ["kovax-palax", "kovax-so", "kovax-sos"]; // List of players to wait for before casting Battle Orders (mode 0). All players must be in the same area as the BOer.
	...
	*/
	...
	//Config.PickitFiles.push("EarlyLadderPickit.nip");

...
function LoadConfig() {
	...
	*/
	...
	Config.Leader = "kovax-so"; // Leader's ingame character name. Leave blank to try auto-detection (works in AutoBaal, Wakka, MFHelper)
	Config.QuitList = ["kovax-so"]; // List of character names to quit with. Example: Config.QuitList = ["MySorc", "MyDin"];

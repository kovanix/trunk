...
function LoadConfig() {
	...
	*/
	...
	Config.Leader = "kovax-palax"; // Leader's ingame character name. Leave blank to try auto-detection (works in AutoBaal, Wakka, MFHelper)
	Config.QuitList = ["kovax-palax"]; // List of character names to quit with. Example: Config.QuitList = ["MySorc", "MyDin"];
	...
	Config.PickitFiles.push("EarlyPickit.nip");
	Config.PickRange = 40; // Pick radius
	Config.FastPick = false; // Check and pick items between attacks

	// Additional item info log settings. All info goes to \logs\ItemLog.txt
	Config.ItemInfo = true; // Log stashed, skipped (due to no space) or sold items.
	Config.ItemInfoQuality = [7, 8]; // The quality of sold items to log. See NTItemAlias.dbl for values. Example: Config.ItemInfoQuality = [6, 7, 8];
	...
	Config.AttackSkill[2] = 56; // Primary untimed skill to bosses. Keep at -1 if Config.AttackSkill[1] is untimed skill.
	...
	Config.StaticList = ["Diablo", "Baal"]; // List of monster NAMES or CLASSIDS to static. Example: Config.StaticList = ["Andariel", 243];

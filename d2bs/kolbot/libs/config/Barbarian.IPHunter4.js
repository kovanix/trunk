...
function LoadConfig() {
	...
	*/
	...
	Scripts.IPHunter = true;
		Config.IPHunter.IPList = [41]; // List of IPs to look for. example: [165, 201, 64]
		Config.IPHunter.GameLength = 7; // Number of minutes to stay in game if ip wasn't found
